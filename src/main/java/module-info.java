module ru.nsu.fit.pixelmind {
    ...
    opens ru.nsu.fit.pixelmind.screens.game.game_field to javafx.fxml;
    exports ru.nsu.fit.pixelmind.screens.game.game_field.tile;
    opens ru.nsu.fit.pixelmind.screens.game.game_field.tile to javafx.fxml;
    ...
    opens ru.nsu.fit.pixelmind.screens.game.character to javafx.fxml;
    exports ru.nsu.fit.pixelmind.screens.game.game_field.tile_map;
    opens ru.nsu.fit.pixelmind.screens.game.game_field.tile_map to javafx.fxml;
