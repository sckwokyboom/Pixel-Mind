...
public class CharacterInteractor {
    private final CharacterViewBuilder characterViewBuilder;
    public CharacterInteractor(CharacterViewBuilder characterViewBuilder) {
    ...
    public void loadSprites(String spriteType) {
        for (int i = 0; i < 10; i++) {
            ...
            characterViewBuilder.getCharacterSprites().add(heroSpriteImage);
        }
    }
}
